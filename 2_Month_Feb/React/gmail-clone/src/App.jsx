        ...
        <header className="gmail-header border-bottom">
          ...
          <InputGroup className="header-search mx-auto">
            ...
            <Form.Control
              ...
              className="bg-transparent border-0"
            />
            <div className="header-search mx-auto d-flex align-items-center justify-content-center me-3">
              <svg
          ...
          <div className="d-flex align-items-center">
            ...
            <div
              className="profile-icon rounded-circle bg-info text-white d-flex align-items-center justify-content-center"
              style={{
                width: "30px",
                height: "30px",
                fontSize: "14px",
            ...
            <div className="col-md-10 main-content">
              <div className=" row main-header">
                <div className="col-3 ">
                  <button
                    variant="link"
                    className="header-btn p-0 btn p-2 align-items-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
